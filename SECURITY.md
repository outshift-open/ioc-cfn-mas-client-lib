...
`ioc-cfn-mas-client-lib` project.
...
The Internet of Cognition (IOC) Cognition Fabric Node (CFN) MAS Client Library (`ioc-cfn-mas-client-lib`) maintainers take all security issues in the project
seriously. Thank you for improving the security of the IOC CFN MAS Client Library. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

The IOC CFN MAS Client Library leverages GitHub's private vulnerability reporting.
