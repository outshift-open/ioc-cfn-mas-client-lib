...
**content_text** | **str** | ContentText is the alignment prompt/context used to initialize the session. | 
**n_steps** | **int** | NSteps is the maximum number of alignment steps. If omitted, defaults to 20. | [optional] [default to 20]
