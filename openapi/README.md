...
- **`public-api-v1.2.yaml`**: Official OpenAPI 3.0 spec from [ioc-cfn-svc](https://github.com/outshift-open/ioc-cfn-svc/blob/main/docs/public-api/public-api-v1.2.yaml)
...
- **Local copy**: `public-api-v1.2.yaml`
...
**DO NOT edit `public-api-v1.2.yaml` directly.** Changes must be made in the [ioc-cfn-svc repository](https://github.com/outshift-open/ioc-cfn-svc).

To update to a newer version:

1. Copy the latest spec from ioc-cfn-svc:
   ```bash
   cp /path/to/ioc-cfn-svc/docs/public-api/public-api-v1.2.yaml .
   ```
